                ...
                <div class="card-body">
                        ...
                        <div class="card-body">
                            <div class="row ">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="{{$name}}_test" name="{{$name}}_test" value="{{$data['configData'][$name]}}">
                                </div>
                                @endforeach
                            </div>
                        </div>
                    ...
                    <div class="card mt-3 mb-3 klarna_live_data" style="display:none;">
                        ...
                        <div class="card-body">
                            <div class="row ">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-3">
                                    <label for="validationCustom01">{{$label}}</label>
                                    <input type="text" class="form-control" id="{{$name}}_live" name="{{$name}}_live" value="wer">
                                </div>
                                @endforeach
                            </div>
                        </div>
                    ...
                    <div class="row ">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
                            ...
                            <input type="hidden" name="klarna_test_mode" class="custom-control-input klarna_test_mode_method" value="test" />

                            <!-- <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="klarna_test_mode" class="custom-control-input klarna_test_mode_method" value="live"><span class="custom-control-label">Live</span>
                            </label> -->
                        </div>
